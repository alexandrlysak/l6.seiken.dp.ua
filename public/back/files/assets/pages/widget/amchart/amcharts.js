        ...
        d.formatValue = function(a, b, c, e, h, f, g, k) {
            if (b) {
                ...
                for (l = 0; l < c.length; l++) {
                    var m = c[l]
                        , p = b[m];
                    void 0 !== p && (p = f ? d.addPrefix(p, k, g, e) : d.formatNumber(p, e),
            ...
            parseDatesDraw: function() {
                ...
                if (0 < this.gridCountR)
                    for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle),
                        ...
                        "MM" == A && (h = (n - l) / y,
                        1.5 <= (n - l) / y && (n = n - (h - 1) * y + d.getPeriodDuration("DD", 3),
        ...
        d.ValueAxis = d.Class({
            ...
            draw: function() {
                ...
                if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
                    ...
                    !0 === h ? (z = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E,
            ...
            stackGraphs: function(a) {
                ...
                if (r && ("regular" == b || "100%" == b))
                    for (q = 0; q < k.length; q++)
                        p = k[q],
                            p.stackGraph = null,
                        p.hidden || (m = p.type,
                        p.chart == this.chart && p.valueAxis == this && a == m && p.stackable && (l && (p.stackGraph = l),
                            l = p));
                p = this.start - 10;
                l = this.end + 10;
                ...
                for (n = p; n <= l; n++) {
                    ...
                    for (q = 0; q < k.length; q++)
                        ...
                        p.chart == this.chart && p.valueAxis == this && a == m && p.stackable)
                            if (m = this.data[n].axes[this.id].graphs[p.id],
                                g = m.values.value,
                                isNaN(g))
                                p.newStack && (h[n] = NaN,
                                    e[n] = NaN);
                                ...
                                "regular" == b && (r && (isNaN(c[n]) ? (c[n] = g,
                                    m.values.close = g,
                                    m.values.open = this.baseValue) : (isNaN(g) ? m.values.close = c[n] : m.values.close = g + c[n],
                                    m.values.open = c[n],
                                    c[n] = m.values.close)),
                                "column" == a && (p.newStack && (h[n] = NaN,
                                    e[n] = NaN),
                                    m.values.close = g,
                                    0 > g ? (m.values.close = g,
                                        isNaN(e[n]) ? m.values.open = t : (m.values.close += e[n],
                                            m.values.open = e[n]),
                                        e[n] = m.values.close) : (m.values.close = g,
                                        isNaN(h[n]) ? m.values.open = t : (m.values.close += h[n],
                                            m.values.open = h[n]),
                                        h[n] = m.values.close)))
                            }
                }
                for (n = this.start; n <= this.end; n++)
                    for (q = 0; q < k.length; q++)
                        (p = k[q],
                            p.hidden) ? p.newStack && (h[n] = NaN,
                            e[n] = NaN) : (m = p.type,
                        p.chart == this.chart && p.valueAxis == this && a == m && p.stackable && (m = this.data[n].axes[this.id].graphs[p.id],
                            g = m.values.value,
                        isNaN(g) || (c = g / f[n] * 100,
                            m.values.percents = c,
                            m.values.total = f[n],
                        p.newStack && (h[n] = NaN,
                            e[n] = NaN),
                        "100%" == b && (isNaN(e[n]) && (e[n] = 0),
                        isNaN(h[n]) && (h[n] = 0),
                            0 > c ? (m.values.close = d.fitToBounds(c + e[n], -100, 100),
                                m.values.open = e[n],
                                e[n] = m.values.close) : (m.values.close = d.fitToBounds(c + h[n], -100, 100),
                                m.values.open = h[n],
                                h[n] = m.values.close)))))
            },
        ...
        d.RecAxis = d.Class({
            construct: function(a) {
                var b = a.chart
                    ...
                    , q = a.width
                    , n = b.container;
                "H" == a.orientation ? (e = d.line(n, [0, q], [0, 0], e, h, c),
                    this.axisWidth = a.width,
                    "bottom" == a.position ? (k = c / 2 + f + p + m - 1,
                        c = l) : (k = -c / 2 - f + m + k,
                        c = g + l)) : (this.axisWidth = a.height,
                    "right" == a.position ? (e = d.line(n, [0, 0, -g], [0, p, p - k], e, h, c),
                        k = m + k,
                        c = c / 2 + f + g + q + l - 1) : (e = d.line(n, [0, 0], [0, p], e, h, c),
                        k = m,
                        c = -c / 2 - f + l));
                e.translate(c, k);
                c = b.container.set();
...
(function() {
        ...
        d.RecItem = d.Class({
            construct: function(a, b, c, e, h, f, g, k, l, m, p, q) {
                ...
                g ? (void 0 !== g.id && (q = n.classNamePrefix + "-guide-" + g.id),
                    P = !0,
                ...
                isNaN(g.labelOffset) || (aa = g.labelOffset)) : "" === c && (B = 0);
                ...
                "V" == Pa && (p = 0);
                var ca;
                P && "" !== c && (ca = a.autoWrap && 0 === p ? d.wrappedText(z, c, w, t, r, ga, k, Math.abs(h), 0) : d.text(z, c, w, t, r, ga, k),
                    ga = ca.getBBox(),
                    ha = ga.width,
                    Qa = ga.height);
                if ("H" == Pa) {
                    ...
                    g && 90 == p && J && (G -= r),
                        ...
                        0 < h && (G += h / 2 - 3,
                            ga = "middle"),
                        0 < p && (ga = "middle")) : ga = "middle",
                    1 == ia && 0 < M && !g && !m && da < xa && (e = d.fitToBounds(b, 0, xa),
                    ...
                    0 < Y && (Da = d.rect(z, Y, a.height, Q, M),
                        ...
                        x.push(Da))),
                        "bottom" == Z ? (v += X + r / 2 + ea,
                            J ? (0 < p ? (v = X - ha / 2 * Math.sin(V) - B - 3,
                            a.centerRotatedLabels || (G += ha / 2 * Math.cos(V) - 4 + 2)) : 0 > p ? (v = X + ha * Math.sin(V) - B - 3 + 2,
                                G += -ha * Math.cos(V) - Qa * Math.sin(V) - 4) : v -= B + r + 3 + 3,
                                v -= aa) : (0 < p ? (v = X + ha / 2 * Math.sin(V) + B + 3,
                            a.centerRotatedLabels || (G -= ha / 2 * Math.cos(V))) : 0 > p ? (v = X + B + 3 - ha / 2 * Math.sin(V) + 2,
                                G += ha / 2 * Math.cos(V)) : v += B + u + 3 + 3,
                                v += aa)) : (v += na + r / 2 - ea,
                            G += ma,
                            J ? (0 < p ? (v = ha / 2 * Math.sin(V) + B + 3,
                            a.centerRotatedLabels || (G -= ha / 2 * Math.cos(V))) : v += B + 3,
                                v += aa) : (0 < p ? (v = -(ha / 2) * Math.sin(V) - B - 6,
                    ...
                    if (!0 === J && "left" == Z || !1 === J && "right" == Z)
                        ga = "start";
                    v = b - Qa / 2 + 2;
                    1 == ia && 0 < M && !g && !m && (e = d.fitToBounds(b, 0, X),
                ...
                Ba && (d.setCN(n, Ba, a.bcn + "grid"),
                    d.setCN(n, Ba, q, !0),
                g && d.setCN(n, Ba, "guide"));
                Da && (d.setCN(n, Da, a.bcn + "fill"),
                    d.setCN(n, Da, q, !0));
                m ? Ba && d.setCN(n, Ba, a.bcn + "grid-minor") : (a.counter = 0 === ia ? 1 : 0,
                    a.previousCoord = b);
...
(function() {
        ...
        d.RecFill = d.Class({
            construct: function(a, b, c, e) {
                ...
                "V" == g ? (g = d.rect(l, a.width, c, p, m),
                    g.translate(h, b - k + f)) : (g = d.rect(l, c, a.height, p, m),
                    g.translate(b - k + h, f));
            ...
            brr: function() {
                if (!this.hideCredits) {
                    ...
                    if (c != a || !0 === this.inIframe()) {
                        ...
                        "ammap" == this.product && (g = a + "/javascript-maps/",
        ...
        d.AmGraph = d.Class({
            ...
            createRadarGraph: function() {
                ...
                for (m = this.start; m <= this.end; m++) {
                    ...
                    "none" == a || "3d" == a ? q = p.values.value : (q = p.values.close,
                        n = p.values.open);
                    if (isNaN(q))
            ...
            positionLabel: function(a, b, c, e, d) {
                if (e) {
                    ...
                    e.translate(b, c);
                    !this.showAllValueLabels && t && l && (p = e.getBBox(),
                    p.height > a.columnHeight || p.width > a.columnWidth) && (e.remove(),
                        e = null);
                    if (e && "radar" != f.type)
                        if (q) {
            ...
            createSerialGraph: function() {
                ...
                if (!(J || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round",
                    this.resetBullet = !0),
                !Ra && void 0 == Ja || m))) {
                    var Ua = Pa;
                    Ua > f.max && (Ua = f.max);
                                ...
                                if (!isNaN(W)) {
                                    ...
                                    if (!(W < Qb && ob < Qb || W > Rb && ob > Rb)) {
                                        ...
                                        if (t) {
                                            ...
                                            K = d.roundTo(K, 2);
                                            ba = d.roundTo(ba, 2);
                                            R < q && 0 < K && (va = new d.Cuboid(h,ba,K,H - a.d3x,Q - a.d3y,Na,Va,da,Ca,X,ga,w,t,ea,bb,mb,aa),
                                            ...
                                            K = d.roundTo(K, 2);
                                            ba = d.roundTo(ba, 2);
                                            S < p + Z * H && 0 < K && (this.showOnAxis && (R -= Q / 2),
                                    ...
                                    if (t) {
                                        ...
                                        if (R < q && 0 < K) {
                                            ...
                                            W > ua ? (Eb = [E, sa],
                                                Fb = [O, qa]) : (Eb = [O, sa],
                                                Fb = [E, qa]);
                                            !isNaN(sa) && !isNaN(qa) && F < q && 0 < F && (Xa = d.line(h, Eb, [F, F], Ca, X, da),
                                        ...
                                        if (S < p && 0 < K) {
                                            ...
                                            W > ua ? (Gb = [F, ta],
                                                Hb = [N, ra]) : (Gb = [N, ta],
                                                Hb = [F, ra]);
                                            !isNaN(ta) && !isNaN(ra) && E < p && 0 < E && (Xa = d.line(h, [E, E], Gb, Ca, X, da),
                ...
                this.lastDataItem = v;
                if ("line" == g || "step" == g || "smoothedLine" == g)
                    "smoothedLine" == g ? this.drawSmoothedGraph(x, u, T, U) : this.drawLineGraph(x, u, T, U),
            ...
            drawLineGraph: function(a, b, c, e) {
                ...
                if (1 < a.length) {
                    ...
                    var z = h.negativeLineColor
                        ...
                        , y = h.baseCoord;
                    0 !== h.negativeBase && (y = h.valueAxis.getCoordinate(h.negativeBase, f),
                    ...
                    void 0 === z || h.useNegativeColorIfDown || (n = d.line(l, a, b, z, r, n, x, !1, !0, f),
                    ...
                    if (0 < g || 0 < A)
                        if (n = a.join(";").split(";"),
                            ...
                            "serial" == q || "radar" == q ? 0 < c.length ? (c.reverse(),
                                ...
                                n.push(0)) : h.rotate ? (r.push(r[r.length - 1]),
                                n.push(y),
                                r.push(r[0]),
                                n.push(y),
                                r.push(r[0]),
                                n.push(n[0])) : (n.push(n[n.length - 1]),
                                r.push(y),
                                n.push(n[0]),
                                r.push(y),
                                n.push(a[0]),
                        ...
                        0 < g && (b = d.polygon(l, n, r, w, g, 1, "#000", 0, a, f),
            ...
            drawSmoothedGraph: function(a, b, c, e) {
                if (1 < a.length) {
                    ...
                    k.push(m.path);
                    void 0 !== r && (p = new d.Bezier(g,a,b,r,A,p,t,0,h,void 0,u),
                    ...
                    0 < q && (p = a.join(";").split(";"),
                        ...
                        0 < c.length ? (c.push("M"),
                            ...
                            e.reverse(),
                            p = a.concat(c),
                            m = b.concat(e)) : (this.rotate ? (n += " L" + x + "," + b[b.length - 1],
            ...
            createBullet: function(a, b, c) {
                if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
                    ...
                    isNaN(l) || (isNaN(k) || (g = (k - m) / (l - m) * (p - q) + q),
                    m == l && (g = p));
                    l = g;
                    ...
                    var n;
                    "xy" == e.type && this.valueField && (n = this.pattern,
                    a.pattern && (n = a.pattern));
                    f = this.bullet;
                    a.bullet && (f = a.bullet);
                    ...
                    if (g && g.enabled && this.showBalloon && !this.hidden) {
                        ...
                        f.rotate && (b = a.y,
                            ...
                            p && g.setBounds(k, l, a + k, q + l),
                                ...
                                g.fixPrevious(),
                            g.fixedPosition && (c = !1),
                                !c && "radar" != f.type && (b < k - .5 || b > a + k || h < l - .5 || h > q + l) ? (g.showBalloon(m),
                                    g.hide(0)) : (g.followCursor(c),
        ...
        d.SimpleChartScrollbar = d.Class({
            ...
            draw: function() {
                ...
                if (a.enabled) {
                    ...
                    if ((a.height = g) && f) {
                        ...
                        d.isAbsolute(k) && (g = "");
                        c ? (l = g + k + "H" + e.extension,
                            g = a.dragIconWidth,
                            c = a.dragIconHeight) : (l = g + k + e.extension,
                            c = a.dragIconWidth,
                            g = a.dragIconHeight);
                        k = b.image(l, 0, 0, c, g);
            ...
            dispatchScrollbarEvent: function() {
                if (this.skipEvent)
                    ...
                    this.getPercents();
                    this.rotate ? (c = d,
                        h = this.height / b) : h = this.width / h;
                    this.fire({
                        type: "zoomed",
                        position: c,
                        chart: a,
        ...
        d.ChartScrollbar = d.Class({
            ...
            zoomScrollbar: function(a) {
                if ((!(this.dragging || this.resizingLeft || this.resizingRight || this.animating) || a) && this.dragger && this.enabled) {
                    ...
                    h.parseDates && !h.equalSpacing ? (a = h.stepWidth,
                        c = d.firstTime,
                        b = a * (this.startTime - c),
                        c = a * (this.endTime - c)) : (a[this.start] && (b = a[this.start].x[h.id]),
            ...
            draw: function() {
                ...
                if (!isNaN(a)) {
                    ...
                    if (this.show) {
                        ...
                        var I = p.offsetWidth
                            , H = p.offsetHeight;
                        p.clientHeight && (I = p.clientWidth,
                            H = p.clientHeight);
                        A = H + 2 * w;
                        C = I + 2 * r;
                        !isNaN(D) && C < D && (C = D);
                        ...
                        this.showBullet && (J = d.circle(h, ia, t, w),
                            f.push(J));
                        this.drop ? (g = C / 1.6,
                            l = 0,
                        "V" == x && (x = "down"),
                        ...
                        "right" == x && (l = 90,
                            ...
                            k = y - H / 2 + 1,
                            m = D - I / 2 - 1,
                            q = d.drop(h, g, l, q, w, r, n, aa)) : 0 < u || 0 === z ? (0 < M && (a = d.rect(h, C, A, q, 0, r + 1, P, M, u),
                            d.isModern ? a.translate(1, 1) : a.translate(4, 4),
                            f.push(a)),
                            q = d.rect(h, C, A, q, w, r, n, aa, u)) : (t = [],
                            u = [],
                            "H" != x ? (g = a - D,
                            g > C - z && (g = C - z),
                            g < z && (g = z),
                        ...
                        0 < M && (a = d.polygon(h, t, u, q, 0, r, P, M),
                            a.translate(1, 1),
                            f.push(a)),
...
(function() {
        ...
        d.polygon = function(a, b, c, e, h, f, g, k, l, m, p) {
            ...
            var q = e
                , n = !1;
            "object" == typeof q && 1 < q.length && (n = !0,
                q = q[0]);
            void 0 === g && (g = q);
            h = {
                fill: q,
        ...
        d.wedge = function(a, b, c, e, h, f, g, k, l, m, p, q, n, t) {
            ...
            if (0 < l) {
                P = " M" + x + "," + (A + l) + " L" + y + "," + (B + l);
                z ? (M || (P += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + y + "," + (B + l) + "," + D + "," + (C + l)),
                    P += " L" + I + "," + (u + l),
                0 < k && (M || (P += " B" + (b - k) + "," + (l + c - w) + "," + (b + k) + "," + (l + c + w) + "," + I + "," + (l + u) + "," + x + "," + (l + A)))) : (P += " A" + f + "," + g + ",0," + Q + ",1," + D + "," + (C + l) + " L" + I + "," + (u + l),
            ...
            z ? (M || (h = " A" + r(b - f) + "," + r(c - g) + "," + r(b + f) + "," + r(c + g) + "," + r(y) + "," + r(B) + "," + r(D) + "," + r(C)),
                g = " M" + r(x) + "," + r(A) + " L" + r(y) + "," + r(B) + h + " L" + r(I) + "," + r(u)) : g = " M" + x + "," + A + " L" + y + "," + B + (" A" + f + "," + g + ",0," + Q + ",1," + D + "," + C) + " L" + I + "," + u;
...
(function() {
        ...
        d.Bezier = d.Class({
            construct: function(a, b, c, e, h, f, g, k, l, m, p) {
                ...
                isNaN(n) && (q.rotate ? (n = 20,
                    t = 4) : (t = 20,
                    n = 4));
                var r, w;
                "object" == typeof g && 1 < g.length && (w = !0,
                    r = g,
                    g = g[0]);
                ...
                for (l = 0; l < b.length; l++)
                    isNaN(b[l]) || isNaN(c[l]) ? (e += this.drawSegment(h, n, t),
...
(function() {
        ...
        d.SVGRenderer = d.Class({
            ...
            pattern: function(a, b, c, e) {
                ...
                b.color && (p = document.createElementNS(d.SVG_NS, "rect"),
        ...
        d.AmLegend = d.Class({
            ...
            arrangeEntries: function() {
                ...
                for (A = 0; A < x.length; A++) {
                    ...
                    u = I.getBBox();
                    var H;
                    this.equalWidths ? H = y * (n + p + this.markerLabelGap) : (H = B,
                        B = B + u.width + f + p);
                ...
                u = z.getBBox();
                l = u.height + 2 * m - 1;
                "left" == a || "right" == a ? (p = u.width + 2 * f,
                    k = p + b + c,
                    g.style.width = k + "px",
                    this.ieW = k) : p = k - b - c - 1;
            ...
            createEntry: function(a) {
                if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                    ...
                    k && "none" != k && 0 < n && ("x" == k ? (x = b.createX(),
                        x.translate(n / 2, n / 2)) : x = b.createV(),
                        x.dItem = a,
                    ...
                    l = b.fontSize;
                    m && (n <= l && (n = n / 2 + b.ly - l / 2 + (l + 2 - n) / 2 - r,
                        m.translate(w, n),
                    x && x.translate(x.x, n)),
                ...
                if (a)
                    for (c = 0; c < a.length; c++) {
                        ...
                        if (e)
                            ...
                            h.text(g);
                            if (!f.pattern && (this.useMarkerColorForValues && h.setAttr("fill", p),
...
(function() {
        ...
        d.resetDateToMin = function(a, b, c, e) {
            ...
            d.useUTC ? (a = new Date,
                ...
                a.setUTCHours(k, l, m, p)) : a = new Date(h,f,g,k,l,m,p);
            return a
        }
        ;
        ...
        d.formatDate = function(a, b, c) {
            ...
            d.useUTC ? (e = a.getUTCFullYear(),
                ...
                l = a.getUTCMinutes(),
                m = a.getUTCSeconds(),
                p = a.getUTCMilliseconds()) : (e = a.getFullYear(),
                h = a.getMonth(),
                f = a.getDate(),
                g = a.getDay(),
                k = a.getHours(),
